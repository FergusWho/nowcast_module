...
then
    ...
    $python_bin $iPATH_dir/prepare_PATH.py --root_dir $root_dir/Flare/$CME_id --path_dir $iPATH_dir --run_mode 0 --input $root_dir/Flare/$CME_id/${CME_dir}_flare_input.json
    ...
    $python_bin $iPATH_dir/prepare_PATH.py --root_dir $root_dir/Flare/$CME_id --path_dir $iPATH_dir --run_mode 2 --ranks $thread_count --input $root_dir/Flare/$CME_id/${CME_dir}_flare_input.json
